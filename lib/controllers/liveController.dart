...
class LiveController extends GetxController {
  ...
  Future<void> createLiveAstrologerShareLink(
    ...
    try {
      await Share.share(
        'Watch $astrologerName live on Astroway app now - ',
        subject:
            'Watch $astrologerName live on Astroway app now -  ${appShareLinkForLiveSreaming} Watch $astrologerName live on Astroway app now - ',
      );
    } catch (e) {
