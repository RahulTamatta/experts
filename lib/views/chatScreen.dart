                            ...
                            label: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 5),
                                  Text(
                                    chatController.categoryList[index].name.length > 12
                                        ? chatController.categoryList[index]
                                                      .name
                                                      .substring(0, 12) +
                                                  '..'
        ...
        return InkWell(
          onTap: () async {
            Get.find<ReviewController>()
                .getReviewData(widget.astrologerList[index].id);
            global.showOnlyLoaderDialog(context);
            await bottomNavigationController
          ...
          child: Column(
            children: [
                              ...
                              Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        '${global.imgBaseurl}${widget.astrologerList[index].profileImage}',
                                    placeholder: (context, url) => const Center(
                                        child: CircularProgressIndicator()),
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                       widget.astrologerList[index].name.length > 12
                      ...
                      Column(
                        children: [
                          ...
                          widget.astrologerList[index].chatStatus == "Offline"
                              ...
                              : widget.astrologerList[index].chatStatus ==
                                      "Wait Time"
                                  ? Text(
                                      widget.astrologerList[index].chatWaitTime!
                                                  .difference(DateTime.now())
                                                  .inMinutes >
                                              0
                                          ? "Wait till - ${widget.astrologerList[index].chatWaitTime!.difference(DateTime.now()).inMinutes} min"
                                          : "Wait till",
                                      style: TextStyle(
                                          color: Colors.red, fontSize: 09),
                                    ).tr()
                          ...
                          widget.astrologerList[index].totalOrder == 0 ||
                                  widget.astrologerList[index].totalOrder ==
                                      null
                              ? SizedBox()
                              : Text(
                                  '${widget.astrologerList[index].totalOrder} orders',
                                  style: Get.theme.primaryTextTheme.bodySmall!
                                      .copyWith(
                                    fontWeight: FontWeight.w300,
                                    fontSize: 9,
              ...
              bottomNavigationController.isMoreDataAvailable == true &&
                  ...
                  : const SizedBox(),
              if (index == widget.astrologerList.length - 1)
                const SizedBox(
                  height: 30,
                )
            ],
